  ...
  return (
    <section className="py-20 bg-slate-950/60 border-t border-slate-800/80" id="download" aria-labelledby="download-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card rounded-3xl p-8 sm:p-12 border border-indigo-500/30 bg-gradient-to-br from-indigo-950/40 via-slate-900/90 to-purple-950/30 text-center flex flex-col items-center space-y-6 relative overflow-hidden">
