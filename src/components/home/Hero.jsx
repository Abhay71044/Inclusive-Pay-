...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-20 md:py-24" id="home">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#4f52f8]/20 rounded-full blur-[140px] pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col text-left space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15]">
              InclusivePay – <span className="bg-gradient-to-r from-[#7a7df9] via-[#4f52f8] to-[#f43f5e] bg-clip-text text-transparent">Accessible UPI</span> for Everyone
            </h1>
            ...
            <div className="relative w-full max-w-[340px] sm:max-w-[360px] aspect-[9/18] bg-slate-950 rounded-[44px] p-3 border-4 border-slate-800 shadow-2xl shadow-indigo-500/20 ring-1 ring-slate-700">
              ...
              <div className="w-full h-full bg-slate-900 rounded-[34px] p-4 flex flex-col justify-between overflow-hidden relative border border-slate-800/60 pt-8">
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-br from-[#4f52f8] via-[#595df5] to-[#6d70fa] rounded-2xl p-4 text-white shadow-xl shadow-indigo-950/50 relative overflow-hidden mb-4 border border-indigo-300/30">
                ...
                <div className="flex flex-col items-center my-2">
                  <button
                    ...
                    className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#4f52f8] via-[#585bf6] to-[#7173fb] text-white flex items-center justify-center shadow-lg shadow-indigo-500/50 hover:scale-110 active:scale-95 transition animate-pulse-glow"
