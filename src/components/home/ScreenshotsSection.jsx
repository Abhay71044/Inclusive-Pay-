        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {previews.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-[#0e1222] to-[#1d2444]/80 border border-slate-800 p-4 flex flex-col items-center justify-center text-center space-y-2">
